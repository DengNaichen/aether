...
#             "/admin/users/", json=new_user_data
#         )
...
#         }
#         response = await authenticated_admin_client.post(
#             "/admin/users/", json=new_admin_data
#         )
#         assert response.status_code == 201
#         data = response.json()
...
#             "password": "password",
#         }
#         response = await authenticated_client.post("/admin/users/", json=new_user_data)
#         assert response.status_code == 403

#     @pytest.mark.asyncio
#     async def test_unauthenticated_user_cannot_create_user(self, client: AsyncClient):
...
#             "password": "password",
#         }
#         response = await client.post("/admin/users/", json=new_user_data)
...
#         }
#         response = await authenticated_admin_client.post(
#             "/admin/users/", json=duplicate_email_data
#         )
