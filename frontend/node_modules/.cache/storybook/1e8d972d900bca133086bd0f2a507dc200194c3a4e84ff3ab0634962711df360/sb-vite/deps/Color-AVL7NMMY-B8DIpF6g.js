...
import { MarkupIcon, __commonJS, __toESM, debounce2, getControlId } from "./dist-DeAsAOWa.js";
import { require_react } from "./react-C2Ypln8Q.js";
import "./client-logger-HqAUJuaT.js";
import { Y7, Z3, i6, xr } from "./components-HAKAA5Ms.js";
import "./jsx-runtime-DGwgWd0g.js";
import "./react-dom-X6cLzIRx.js";
import "./csf-D6FhYf2t.js";
import "./core-events-CRWQOTn9.js";

//#region node_modules/@storybook/addon-docs/dist/Color-AVL7NMMY.mjs
...
var require_conversions = __commonJS({ "../../node_modules/color-convert/conversions.js"(exports, module) {
	...
	convert2.ansi16.rgb = function(args) {
		...
		let mult = (~~(args > 50) + 1) * .5, r2 = (color & 1) * mult * 255, g2 = (color >> 1 & 1) * mult * 255, b2 = (color >> 2 & 1) * mult * 255;
		return [
			r2,
			g2,
			b2
...
var Wrapper = xr.div({
...
}), TooltipContent = xr.div({
	width: 200,
	margin: 5,
	".react-colorful__saturation": { borderRadius: "4px 4px 0 0" },
	".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" },
	".react-colorful__last-control": { borderRadius: "0 0 4px 4px" }
}), Note = xr(i6)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })), Swatches = xr.div({
	display: "grid",
	...
	marginTop: 5,
	width: 200
}), SwatchColor = xr.div(({ theme, active }) => ({
	width: 16,
	height: 16,
...
}, Input = xr(Z3.Input)(({ theme, readOnly }) => ({
	width: "100%",
	paddingLeft: 30,
	paddingRight: 30,
	boxSizing: "border-box",
	fontFamily: theme.typography.fonts.base
})), ToggleIcon = xr(MarkupIcon)(({ theme }) => ({
	position: "absolute",
	zIndex: 1,
	top: 6,
	right: 7,
	...
	let realValue = (0, import_react.useMemo)(() => getRealValue(value, color, colorSpace).toLowerCase(), [
		value,
		color,
		colorSpace
	...
	} : parseValue(preset.color)).concat(selectedColors).filter(Boolean).slice(-27), [presetColors, selectedColors]), addPreset = (0, import_react.useCallback)((color) => {
	...
	return import_react.createElement(Wrapper, { "aria-readonly": readonly }, import_react.createElement(PickerTooltip, {
		...
		tooltip: import_react.createElement(TooltipContent, null, import_react.createElement(Picker, {
			...
			onFocus,
			onBlur
		}), presets.length > 0 && import_react.createElement(Swatches, null, presets.map((preset, index) => import_react.createElement(Y7, {
...
//# sourceMappingURL=Color-AVL7NMMY-B8DIpF6g.js.map