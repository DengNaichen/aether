import { __toESM as __toESM$1 } from "./chunk-B4p5S3KX.js";
import { require_preview_api } from "./preview-api-xvRLWsCc.js";
import { AddIcon, ChevronDownIcon, ChevronRightIcon, ChevronSmallDownIcon, ChevronSmallUpIcon, DocumentIcon, EyeCloseIcon, EyeIcon, LinkIcon, SubtractIcon, UndoIcon, ZoomIcon, ZoomOutIcon, ZoomResetIcon, __commonJS, __require, __toESM, cloneDeep, getControlId, getControlSetterButtonId, pickBy, uniq2 } from "./dist-DeAsAOWa.js";
import { require_react } from "./react-C2Ypln8Q.js";
import { require_client_logger } from "./client-logger-HqAUJuaT.js";
import { Ai, Ir, Ir$1, J, Me, N, St, Tt, Ya, Z3, Z7, at, dw, fi, g3, hf, ii, jl, jo, l3, ml, pf, qo, ru, ui, vw, xo, xr, yO } from "./components-HAKAA5Ms.js";
import { Xr, require_channels } from "./csf-D6FhYf2t.js";
import { require_core_events } from "./core-events-CRWQOTn9.js";
import { Tn, ha } from "./docs-tools-sF2y6cHU.js";
import { dedent } from "./esm-brHMcght.js";

//#region node_modules/@storybook/addon-docs/dist/blocks.mjs
var import_react = /* @__PURE__ */ __toESM$1(require_react(), 1);
var import_client_logger = /* @__PURE__ */ __toESM$1(require_client_logger(), 1);
var import_core_events = /* @__PURE__ */ __toESM$1(require_core_events(), 1);
var import_preview_api = /* @__PURE__ */ __toESM$1(require_preview_api(), 1);
var import_channels = /* @__PURE__ */ __toESM$1(require_channels(), 1);
		...
		return function e2(t2, n2, r2) {
			function s2(o3, u2) {
				if (!n2[o3]) {
					if (!t2[o3]) {
						...
						var f2 = /* @__PURE__ */ new Error("Cannot find module '" + o3 + "'");
			...
			3: [function(_dereq_, module3, exports3) {
				...
				function moveToMostRecentLru(lru, lruPath) {
					var lruLen = lru.length, lruPathLen = lruPath.length, isMatch, i2, ii$1;
					for (i2 = 0; i2 < lruLen; i2++) {
						for (isMatch = !0, ii$1 = 0; ii$1 < lruPathLen; ii$1++) if (!isEqual(lru[i2][ii$1].arg, lruPath[ii$1].arg)) {
							isMatch = !1;
							break;
						}
						if (isMatch) break;
...
function _wrapNativeSuper(t2) {
	...
	return _wrapNativeSuper = function(t3) {
		...
		return Wrapper11.prototype = Object.create(t3.prototype, { constructor: {
			value: Wrapper11,
			enumerable: !1,
			writable: !0,
			configurable: !0
...
var StyledSyntaxHighlighter = xr(ru)(({ theme }) => ({
...
var SourceSkeletonWrapper = xr.div(({ theme }) => ({
...
})), SourceSkeletonPlaceholder = xr.div(({ theme }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	height: 17,
	marginTop: 1,
	width: "60%",
	[`&:first-child${hf}`]: { margin: 0 }
})), SourceSkeleton = () => import_react.createElement(SourceSkeletonWrapper, null, import_react.createElement(SourceSkeletonPlaceholder, null), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } })), Source = ({ isLoading, error, language, code, dark, format: format3 = !0,...rest }) => {
	let { typography } = St();
	...
	return import_react.createElement(Tt, { theme: Ir$1({
		...overrideTheme,
		fontCode: typography.fonts.mono,
		fontBase: typography.fonts.base
	}) }, syntaxHighlighter);
};
var toGlobalSelector = (element) => `& :where(${element}:not(.sb-anchor, .sb-unstyled, .sb-unstyled ${element}))`, breakpoint = 600, Title = xr.h1(N, ({ theme }) => ({
...
var { PREVIEW_URL } = globalThis, BASE_URL = PREVIEW_URL || "iframe.html", storyBlockIdFromId = ({ story, primary }) => `story--${story.id}${primary ? "--primary" : ""}`, InlineStory = (props) => {
	...
	id: `iframe--${story.id}`,
	title: story.name,
	src: vw(BASE_URL, story.id, { viewMode: "story" }),
	allowFullScreen: !0,
	scale,
	style: {
		width: "100%",
...
}))), ErrorMessage = xr.strong(({ theme }) => ({ color: theme.color.orange })), Story = (props) => {
...
}, StorySkeleton = () => import_react.createElement(dw, null);
var Bar = xr(jo)({
	position: "absolute",
	left: 0,
	right: 0,
	...
	2,
	3
].map((key) => import_react.createElement(IconPlaceholder, { key })) : import_react.createElement(import_react.Fragment, null, import_react.createElement(xo, {
	key: "zoomin",
	onClick: (e2) => {
		e2.preventDefault(), zoom(.8);
	},
	title: "Zoom in"
}, import_react.createElement(ZoomIcon, null)), import_react.createElement(xo, {
	key: "zoomout",
	onClick: (e2) => {
		e2.preventDefault(), zoom(1.25);
	},
	title: "Zoom out"
}, import_react.createElement(ZoomOutIcon, null)), import_react.createElement(xo, {
	key: "zoomreset",
	onClick: (e2) => {
...
var ChildrenContainer = xr.div(({ isColumn, columns, layout }) => ({
	...
	alignContent: "center",
	alignItems: "center"
} : {}, ({ columns }) => columns && columns > 1 ? { ".innerZoomElementWrapper > *": { minWidth: `calc(100% / ${columns} - 20px)` } } : {}), StyledSource = xr(Source)(({ theme }) => ({
	margin: 0,
...
})), PreviewContainer = xr.div(({ theme, withSource, isExpanded }) => ({
	position: "relative",
	overflow: "hidden",
	margin: "25px 0 40px",
...
var PositionedToolbar = xr(Toolbar)({
	position: "absolute",
	top: 0,
	left: 0,
	right: 0,
	...
	overflow: "hidden",
	position: "relative"
}), Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = !1, isExpanded = !1, additionalActions, className, layout = "padded", inline = !1,...props }) => {
	let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat([
		"sbdocs",
		"sbdocs-preview",
		"sb-unstyled"
		...
		let { createCopyToClipboardFunction } = await import("./components-DGmckq0j.js");
	...
	return import_react.createElement(PreviewContainer, {
		...
		layout,
		inline
	}, import_react.createElement(l3.Element, {
		centered: layout === "centered",
		scale: inline ? scale : 1
	}, Array.isArray(children) ? children.map((child, i2) => import_react.createElement("div", { key: i2 }, child)) : import_react.createElement("div", null, children))), import_react.createElement(Ya, { actionItems }))), withSource && expanded && source);
};
xr(Preview)(() => ({ ".docs-story": {
	paddingTop: 32,
	paddingBottom: 40
} }));
var TabbedArgsTable = ({ tabs,...props }) => {
	...
	return entries.length === 1 ? import_react.createElement(ArgsTable, {
		...entries[0][1],
		...props
	}) : import_react.createElement(ml, null, entries.map((entry, index) => {
...
}), Wrapper3 = xr.div(N, ({ theme }) => ({
	...getBlockBackgroundStyle(theme),
	margin: "25px 0 40px",
	padding: "30px 20px"
})), Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText,...props }) => import_react.createElement(Wrapper3, {
	...props,
	className: "docblock-typeset sb-unstyled"
}, fontSizes.map((size) => import_react.createElement(TypeSpecimen, { key: size }, import_react.createElement(Label, null, size), import_react.createElement(Sample, { style: {
	fontFamily,
	fontSize: size,
	fontWeight,
	lineHeight: 1.2
} }, sampleText || "Was he a beast if music could move him so?"))));
var ItemTitle = xr.div(({ theme }) => ({
	fontWeight: theme.typography.weight.bold,
	color: theme.color.defaultText
})), ItemSubtitle = xr.div(({ theme }) => ({ color: theme.base === "light" ? curriedTransparentize$1(.2, theme.color.defaultText) : curriedTransparentize$1(.6, theme.color.defaultText) })), ItemDescription = xr.div({
	flex: "0 0 30%",
	lineHeight: "20px",
	marginTop: 5
}), SwatchLabel = xr.div(({ theme }) => ({
	flex: 1,
	textAlign: "center",
	fontFamily: theme.typography.fonts.mono,
...
}), ListName = xr.div({ flex: "0 0 30%" }), ListSwatches = xr.div({ flex: 1 }), ListHeading = xr.div(({ theme }) => ({
	display: "flex",
	flexDirection: "row",
	alignItems: "center",
	paddingBottom: 20,
...
var ItemLabel = xr.div(({ theme }) => ({
	...
	gridAutoRows: 50
}), IconItem = ({ name, children }) => import_react.createElement(Item2, null, import_react.createElement(ItemSpecimen, null, children), import_react.createElement(ItemLabel, null, name)), IconGallery = ({ children,...props }) => import_react.createElement(jl, null, import_react.createElement(List2, {
	...props,
...
var l = [
	...
	"srcDoc",
	"action"
], s = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, d = /mailto:/i, u = /\n{2,}$/, p = /^(\s*>[\s\S]*?)(?=\n\n|$)/, f = /^ *> ?/gm, h = /^(?:\[!([^\]]*)\]\n)?([\s\S]*)/, m = /^ {2,}\n/, g = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, y = /^(?: {1,3})?(`{3,}|~{3,}) *(\S+)? *([^\n]*?)?\n([\s\S]*?)(?:\1\n?|$)/, k = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, x = /^(`+)((?:\\`|(?!\1)`|[^`])+)\1/, b = /^(?:\n *)*\n/, v = /\r\n?/g, C = /^\[\^([^\]]+)](:(.*)((\n+ {4,}.*)|(\n(?!\[\^).+))*)/, $ = /^\[\^([^\]]+)]/, S = /\f/g, w = /^---[ \t]*\n(.|\n)*\n---[ \t]*\n/, E = /^\s*?\[(x|\s)\]/, z = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, L = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, A = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, O = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?((?:[^>]*[^/])?)>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1\b)[\s\S])*?)<\/\1>(?!<\/\1>)\n*/i, T = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, B = /^<!--[\s\S]*?(?:-->)/, M = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, R = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, I = /^\{.*\}$/, D = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, U = /^<([^ >]+@[^ >]+)>/, N$1 = /^<([^ >]+:\/[^ >]+)>/, j = /-([a-z])?/gi, H = /^(\|.*)\n(?: *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*))?\n?/, P = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, _ = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, F = /^\[([^\]]*)\] ?\[([^\]]*)\]/, W = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, G = /\t/g, Z = /(^ *\||\| *$)/g, q = /^ *:-+: *$/, Q = /^ *:-+ *$/, V = /^ *-+: *$/, X = "((?:\\[.*?\\][([].*?[)\\]]|<.*?>(?:.*?<.*?>)?|`.*?`|\\\\\\1|[\\s\\S])+?)", J$1 = /* @__PURE__ */ new RegExp(`^([*_])\\1${X}\\1\\1(?!\\1)`), K = /* @__PURE__ */ new RegExp(`^([*_])${X}\\1(?!\\1)`), Y = /* @__PURE__ */ new RegExp(`^(==)${X}\\1`), ee = /* @__PURE__ */ new RegExp(`^(~~)${X}\\1`), te = /^\\([^0-9A-Za-z\s])/, ne = /\\([^0-9A-Za-z\s])/g, re = /^([\s\S](?:(?!  |[0-9]\.)[^=*_~\-\n<`\\\[!])*)/, ie = /^\n+/, le = /^([ \t]*)/, oe = /\\([^\\])/g, ae = /(?:^|\n)( *)$/, ce = "(?:\\d+\\.)", se = "(?:[*+-])";
function de(e2) {
	return "( *)(" + (e2 === 1 ? ce : se) + ") +";
}
var ue = de(1), pe = de(2);
function fe(e2) {
	return /* @__PURE__ */ new RegExp("^" + (e2 === 1 ? ue : pe));
}
var he = fe(1), me = fe(2);
function ge(e2) {
...
function xe(e2) {
	let t2 = e2 === 1 ? ce : se;
	return /* @__PURE__ */ new RegExp("^( *)(" + t2 + ") [\\s\\S]+?(?:\\n{2,}(?! )(?!\\1" + t2 + " (?!" + t2 + " ))\\n*|\\s*\\n*$)");
}
var be = xe(1), ve = xe(2);
function Ce(e2, t2) {
	let n2 = t2 === 1, i2 = n2 ? be : ve, l2 = n2 ? ye : ke, o2 = n2 ? he : me;
	return {
		match: Me$1(function(e3, t3) {
...
`).match(l2), c2 = !1;
			return {
				items: a2.map(function(e4, n3) {
					let i4 = o2.exec(e4)[0].length, l3$1 = new RegExp("^ {1," + i4 + "}", "gm"), s2 = e4.replace(l3$1, "").replace(o2, ""), d2 = n3 === a2.length - 1, u2 = s2.indexOf(`
...
var $e = /* @__PURE__ */ new RegExp(`^\\[((?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*)\\]\\(\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`), Se = /^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, we = [
	p,
	y,
	k,
	z,
...
`, { inline: t2 }));
			...
			if (r2 !== -1) {
				...
				let d2 = t3[s2] = function(e3, t4, n5, r3) {
					return t4 === "style" ? function(e4) {
						let t5 = [], n6 = "", r4 = !1, i3 = !1, l2 = "";
						if (!e4) return t5;
						for (let o4 = 0; o4 < e4.length; o4++) {
							let a3 = e4[o4];
							if (a3 !== "\"" && a3 !== "'" || r4 || (i3 ? a3 === l2 && (i3 = !1, l2 = "") : (i3 = !0, l2 = a3)), a3 === "(" && n6.endsWith("url") ? r4 = !0 : a3 === ")" && r4 && (r4 = !1), a3 !== ";" || i3 || r4) n6 += a3;
							else {
								let e5 = n6.trim();
								if (e5) {
									let n7 = e5.indexOf(":");
	...
	i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || He, i2.slugify = i2.slugify || Le, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, o, i2.namedCodesToUnicode) : o, i2.createElement = i2.createElement || import_react.createElement;
	let Q2 = [], V2 = {}, X2 = {
		[r.blockQuote]: {
			match: De(p),
			order: 1,
		...
		[r.codeBlock]: {
			...
			render: (e2, n3, r2) => u2("pre", { key: r2.key }, u2("code", t({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text))
		},
		[r.codeFenced]: {
			match: De(y),
			order: 0,
		...
		[r.codeInline]: {
			...
			render: (e2, t2, n3) => u2("code", { key: n3.key }, e2.text)
		},
		[r.footnote]: {
			match: De(C),
			order: 0,
		...
		[r.htmlBlock]: {
			...
			parse(e2, t2, n3) {
				...
				var c2;
				let s2 = e2[1].toLowerCase(), d2 = a.indexOf(s2) !== -1, u3 = (d2 ? s2 : e2[1]).trim(), p2 = {
					attrs: q2(u3, e2[2]),
					noInnerParse: d2,
					tag: u3
				};
			...
			render: (e2, n3, r2) => u2(e2.tag, t({ key: r2.key }, e2.attrs), e2.text || (e2.children ? n3(e2.children, r2) : ""))
		},
		[r.htmlSelfClosing]: {
			match: Ue(R),
			order: 1,
			...
			render: (e2, n3, r2) => u2(e2.tag, t({}, e2.attrs, { key: r2.key }))
		},
		[r.htmlComment]: {
			match: Ue(B),
			order: 1,
		...
		[r.linkBareUrlDetector]: {
			match: Me$1((e2, t2) => t2.inAnchor || i2.disableAutoLink ? null : Re(D)(e2, t2)),
			order: 0,
			parse: (e2) => ({
				children: [{
					text: e2[1],
...
`
		...
		[r.paragraph]: {
			...
			order: 3,
			parse: Ge,
			render: (e2, t2, n3) => u2("p", { key: n3.key }, t2(e2.children, n3))
		},
		[r.ref]: {
			match: Re(P),
			order: 0,
		...
		[r.refLink]: {
			...
			render: (e2, t2, n3) => V2[e2.ref] ? u2("a", {
				...
				title: V2[e2.ref].title
			}, t2(e2.children, n3)) : u2("span", { key: n3.key }, e2.fallbackChildren)
		},
		[r.table]: {
			match: De(H),
			order: 1,
		...
		[r.textBolded]: {
			...
			render: (e2, t2, n3) => u2("strong", { key: n3.key }, t2(e2.children, n3))
		},
		[r.textEmphasized]: {
			match: Ie(K),
			order: 3,
			parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }),
			render: (e2, t2, n3) => u2("em", { key: n3.key }, t2(e2.children, n3))
		},
		[r.textEscaped]: {
			match: Ie(te),
			order: 1,
		...
		[r.textMarked]: {
			...
			order: 3,
			parse: Ge,
			render: (e2, t2, n3) => u2("mark", { key: n3.key }, t2(e2.children, n3))
		},
		[r.textStrikethroughed]: {
			match: Ie(ee),
			order: 3,
			parse: Ge,
			render: (e2, t2, n3) => u2("del", { key: n3.key }, t2(e2.children, n3))
		}
	};
		...
		function n3(r2, i3) {
			...
			for (i3.prevCapture = i3.prevCapture || ""; r2;) {
				...
				for (; d2 < t2.length;) {
					...
					if (u3) {
						s2 = u3[0], i3.prevCapture += s2, r2 = r2.substring(s2.length), o2 = l2.parse(u3, n3, i3), o2.type ??= c2, a2.push(o2);
						break;
					}
					d2++;
				}
...
`).replace(S, "").replace(G, "    ");
	...
	return Q2.length ? u2("div", null, se2, u2("footer", { key: "footer" }, Q2.map(function(e2) {
		return u2("div", {
			...
			key: e2.identifier
		}, e2.identifier, ae2(oe2(e2.footnote, { inline: !0 })));
	}))) : se2;
}
var index_modern_default = (t2) => {
	let { children: r2 = "", options: i2 } = t2, l2 = function(e2, t3) {
		if (e2 == null) return {};
		var n2, r3, i3 = {}, l3$1 = Object.keys(e2);
		for (r3 = 0; r3 < l3$1.length; r3++) t3.indexOf(n2 = l3$1[r3]) >= 0 || (i3[n2] = e2[n2]);
		return i3;
	}(t2, n);
	return import_react.cloneElement(Xe(r2, i2), l2);
};
var Label2 = xr.label(({ theme }) => ({
	lineHeight: "18px",
	alignItems: "center",
	marginBottom: 8,
	display: "inline-block",
...
})), parse = (value2) => value2 === "true", BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus, argType }) => {
	let onSetFalse = (0, import_react.useCallback)(() => onChange(!1), [onChange]), readonly = !!argType?.table?.readonly;
	if (value2 === void 0) return import_react.createElement(Ir, {
		variant: "outline",
		size: "medium",
...
}, FormInput = xr(Z3.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 })), FlexSpaced = xr.div(({ theme }) => ({
	flex: 1,
	display: "flex",
	input: {
		marginLeft: 10,
...
var Wrapper4 = xr.label({ display: "flex" }), parse2 = (value2) => {
	let result = parseFloat(value2);
	return Number.isNaN(result) ? void 0 : result;
}, format2 = (value2) => value2 != null ? String(value2) : "", FormInput2 = xr(Z3.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 })), NumberControl = ({ name, value: value2, onChange, min, max, step, onBlur, onFocus, argType }) => {
	let [inputValue, setInputValue] = (0, import_react.useState)(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = (0, import_react.useState)(!1), [parseError, setParseError] = (0, import_react.useState)(null), readonly = !!argType?.table?.readonly, handleChange = (0, import_react.useCallback)((event) => {
		setInputValue(event.target.value);
		let result = parseFloat(event.target.value);
		Number.isNaN(result) ? setParseError(/* @__PURE__ */ new Error(`'${event.target.value}' is not a number`)) : (onChange(result), setParseError(null));
	...
	}, [value2]), value2 === void 0 ? import_react.createElement(Ir, {
		variant: "outline",
		size: "medium",
		id: getControlSetterButtonId(name),
		onClick: onForceVisible,
		disabled: readonly
	}, "Set number") : import_react.createElement(Wrapper4, null, import_react.createElement(FormInput2, {
		ref: htmlElRef,
...
var Wrapper5 = xr.div(({ isInline }) => isInline ? {
	display: "flex",
	flexWrap: "wrap",
	alignItems: "flex-start",
	label: {
...
}), Text = xr.span({ "[aria-readonly=true] &": { opacity: .5 } }), Label3 = xr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
	"&:last-child": { marginBottom: 0 },
...
}), CheckboxControl = ({ name, options, value: value2, onChange, isInline, argType }) => {
	...
	return import_react.createElement(Wrapper5, {
		...
		}), import_react.createElement(Text, null, key));
	}));
};
var Wrapper6 = xr.div(({ isInline }) => isInline ? {
	display: "flex",
	flexWrap: "wrap",
	alignItems: "flex-start",
	label: {
	...
	if (props["aria-readonly"] === "true") return { input: { cursor: "not-allowed" } };
}), Text2 = xr.span({ "[aria-readonly=true] &": { opacity: .5 } }), Label4 = xr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
	"&:last-child": { marginBottom: 0 },
...
}), RadioControl = ({ name, options, value: value2, onChange, isInline, argType }) => {
	...
	return import_react.createElement(Wrapper6, {
		"aria-readonly": readonly,
		isInline
	}, Object.keys(options).map((key, index) => {
		let id = `${controlId}-${index}`;
		return import_react.createElement(Label4, {
			key: id,
			htmlFor: id
		}, import_react.createElement("input", {
			type: "radio",
...
var styleResets = {
	...
	fontSize: "inherit",
	position: "relative"
}, OptionsSelect = xr.select(styleResets, ({ theme }) => ({
	boxSizing: "border-box",
	position: "relative",
	padding: "6px 10px",
	width: "100%",
...
var JsonArray = class extends import_react.Component {
	...
	renderCollapsed() {
		let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, getStyle, dataType, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && (0, import_react.cloneElement)(minusMenuElement, {
			onClick: handleRemove,
			className: "rejt-minus-menu",
			style: minus,
			"aria-label": `remove the array '${String(name)}'`
		});
		return import_react.createElement(import_react.Fragment, null, import_react.createElement("span", { style: collapsed }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
	}
	renderNotCollapsed() {
		...
		return import_react.createElement(import_react.Fragment, null, import_react.createElement("span", {
...
var JsonValue = class extends import_react.Component {
	...
	render() {
		...
		return import_react.createElement("li", {
			...
			className: "rejt-name",
			style: style.name
		}, name, " : "), isEditing ? import_react.createElement("span", {
			className: "rejt-edit-form",
			style: style.editForm
		}, inputElementLayout) : import_react.createElement("span", {
			className: "rejt-value",
			style: style.value,
...
var { window: globalWindow2 } = globalThis, Wrapper7 = xr.div(({ theme }) => ({
	position: "relative",
	display: "flex",
...
})), ButtonInline = xr.button(({ theme, primary }) => ({
	border: 0,
	height: 20,
	margin: 1,
	borderRadius: 4,
...
})), Input = xr.input(({ theme, placeholder }) => ({
	outline: 0,
	...
	if ((0, import_react.useEffect)(() => {
		forceVisible && htmlElRef.current && htmlElRef.current.select();
	}, [forceVisible]), !hasData) return import_react.createElement(Ir, {
		disabled: readonly,
		id: getControlSetterButtonId(name),
		onClick: onForceVisible
	}, "Set object");
	...
	return import_react.createElement(Wrapper7, { "aria-readonly": readonly }, isObjectOrArray && import_react.createElement(RawButton, {
		role: "switch",
...
var RangeInput = xr.input(({ theme, min, max, value: value2, disabled }) => ({
	"&": {
		width: "100%",
	...
	"[aria-readonly=true] &": { opacity: .5 }
}), RangeCurrentAndMaxLabel = xr(RangeLabel)(({ numberOFDecimalsPlaces, max }) => ({
...
var Wrapper8 = xr.label({ display: "flex" }), MaxLength = xr.div(({ isMaxed }) => ({
	marginLeft: "0.75rem",
	paddingTop: "0.35rem",
	color: isMaxed ? "red" : void 0
})), TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
	let handleChange = (event) => {
	...
	return import_react.createElement(Wrapper8, null, import_react.createElement(Z3.Textarea, {
		id: getControlId(name),
		maxLength,
		onChange: handleChange,
		disabled: readonly,
		...
		onFocus,
		onBlur
	}), maxLength && import_react.createElement(MaxLength, { isMaxed: value2?.length === maxLength }, value2?.length ?? 0, " / ", maxLength));
};
...
var FilesControl = ({ onChange, name, accept = "image/*", value: value2, argType }) => {
	...
	}, [value2, name]), import_react.createElement(FileInput, {
		ref: inputElement,
		id: getControlId(name),
		type: "file",
		name,
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-B8DIpF6g.js")), ColorControl = (props) => import_react.createElement(import_react.Suspense, { fallback: import_react.createElement("div", null) }, import_react.createElement(LazyColorControl, { ...props }));
var Controls2 = {
	array: ObjectControl,
	...
	if (!control || control.disable) {
		...
		return isHovered && canBeSetup ? import_react.createElement(Ai, {
...
var ITEMS_BEFORE_EXPANSION = 8, Summary = xr.div(({ isExpanded }) => ({
	display: "flex",
	...
	marginBottom: "-4px",
	minWidth: 100
})), Text3 = xr.span(at, ({ theme, simple = !1 }) => ({
	flex: "0 0 auto",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
	wordBreak: "break-word",
...
})), ExpandButton = xr.button(({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	marginBottom: "4px",
	background: "none",
	border: "none"
})), Expandable = xr.div(at, ({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	fontSize: theme.typography.size.s1,
	margin: 0,
...
})), ChevronUpIcon = xr(ChevronSmallUpIcon)({ marginLeft: 4 }), ChevronDownIcon$1 = xr(ChevronSmallDownIcon)({ marginLeft: 4 }), EmptyArg = () => import_react.createElement("span", null, "-"), ArgText = ({ text, simple }) => import_react.createElement(Text3, { simple }, text), calculateDetailWidth = (0, import_memoizerific.default)(1e3)((detail) => {
	...
	let { summary, detail } = value2, [isOpen, setIsOpen] = (0, import_react.useState)(!1), [isExpanded, setIsExpanded] = (0, import_react.useState)(initialExpandedArgs || !1);
	...
	return import_react.createElement(Z7, {
		...
		tooltip: import_react.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react.createElement(ru, {
			language: "jsx",
			format: !1
		}, detail))
	}, import_react.createElement(Expandable, { className: "sbdocs-expandable" }, import_react.createElement("span", null, summaryAsString), isOpen ? import_react.createElement(ChevronUpIcon, null) : import_react.createElement(ChevronDownIcon$1, null)));
}, ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? import_react.createElement(EmptyArg, null) : import_react.createElement(ArgSummary, {
	value: value2,
	initialExpandedArgs
});
var Name = xr.span({ fontWeight: "bold" }), Required = xr.span(({ theme }) => ({
	color: theme.color.negative,
	fontFamily: theme.typography.fonts.mono,
	cursor: "help"
})), Description = xr.div(({ theme }) => ({
	"&&": {
		p: { margin: "0 0 10px 0" },
...
})), Type = xr.div(({ theme, hasDescription }) => ({
...
})), TypeWithJsDoc = xr.div(({ theme, hasDescription }) => ({
	color: theme.base === "light" ? curriedTransparentize$1(.1, theme.color.defaultText) : curriedTransparentize$1(.2, theme.color.defaultText),
	marginTop: hasDescription ? 12 : 0,
	marginBottom: 12
})), StyledTd = xr.td(({ expandable }) => ({ paddingLeft: expandable ? "40px !important" : "20px !important" })), toSummary = (value2) => value2 && { summary: typeof value2 == "string" ? value2 : value2.name }, ArgRow = (props) => {
	let [isHovered, setIsHovered] = (0, import_react.useState)(!1), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || toSummary(row.type), defaultValue = table.defaultValue || row.defaultValue, required = row.type?.required, hasDescription = description != null && description !== "";
	return import_react.createElement("tr", {
		onMouseEnter: () => setIsHovered(!0),
		onMouseLeave: () => setIsHovered(!1)
	}, import_react.createElement(StyledTd, { expandable: expandable ?? !1 }, import_react.createElement(Name, null, name), required ? import_react.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react.createElement("td", null, hasDescription && import_react.createElement(Description, null, import_react.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react.createElement(import_react.Fragment, null, import_react.createElement(TypeWithJsDoc, { hasDescription }, import_react.createElement(ArgValue, {
		value: type,
		initialExpandedArgs
...
var Wrapper9 = xr.div(({ inAddonPanel, theme }) => ({
	...
	return (0, import_react.useEffect)(() => {
	...
	}, []), isLoading ? null : import_react.createElement(Wrapper9, { inAddonPanel }, import_react.createElement(qo, {
		...
		footer: import_react.createElement(Links, null, inAddonPanel && import_react.createElement(import_react.Fragment, null, import_react.createElement(Ai, {
			href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
			target: "_blank",
			withArrow: !0
		}, import_react.createElement(DocumentIcon, null), " Read docs")), !inAddonPanel && import_react.createElement(Ai, {
			href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
			target: "_blank",
			withArrow: !0
...
var ExpanderIconDown = xr(ChevronDownIcon)(({ theme }) => ({
	marginRight: 8,
	marginLeft: -10,
	marginTop: -2,
	height: 12,
	...
	border: "none",
	display: "inline-block"
})), ExpanderIconRight = xr(ChevronRightIcon)(({ theme }) => ({
	marginRight: 8,
	marginLeft: -10,
	marginTop: -2,
	height: 12,
...
}), SkeletonText = xr.div(({ theme, width, height }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	width: width || "100%",
	height: height || 16,
...
} })), TablePositionWrapper = xr.div({ position: "relative" }), ButtonPositionWrapper = xr.div({
	position: "absolute",
	right: 8,
	top: 6
});
var sortFns = {
	...
	if ("error" in props) {
		let { error } = props;
		return import_react.createElement(EmptyBlock, null, error, "\xA0", import_react.createElement(Ai, {
	...
	return import_react.createElement(jl, null, import_react.createElement(TablePositionWrapper, null, updateArgs && !isLoading && resetArgs && import_react.createElement(ButtonPositionWrapper, null, import_react.createElement(xo, {
		onClick: () => resetArgs(),
	...
	}, import_react.createElement("thead", { className: "docblock-argstable-head" }, import_react.createElement("tr", null, import_react.createElement("th", null, import_react.createElement("span", null, "Name")), compact ? null : import_react.createElement("th", null, import_react.createElement("span", null, "Description")), compact ? null : import_react.createElement("th", null, import_react.createElement("span", null, "Default")), updateArgs ? import_react.createElement("th", null, import_react.createElement("span", null, "Control")) : null)), import_react.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react.createElement(ArgRow, {
		key: row.key,
		row,
...
var require_es_object_atoms = __commonJS2({ "node_modules/.pnpm/es-object-atoms@1.1.1/node_modules/es-object-atoms/index.js"(exports, module) {
	...
	module.exports = function(name, allowMissing) {
		...
		for (var i2 = 1, isOwn = !0; i2 < parts.length; i2 += 1) {
			...
			if ((part === "constructor" || !isOwn) && (skipFurtherCaching = !0), intrinsicBaseName += "." + part, intrinsicRealName = "%" + intrinsicBaseName + "%", hasOwn(INTRINSICS, intrinsicRealName)) value2 = INTRINSICS[intrinsicRealName];
			else if (value2 != null) {
				if (!(part in value2)) {
...
function baseIsNative(value2) {
	...
	return (isFunction_default(value2) ? reIsNative : reIsHostCtor).test(toSource_default(value2));
}
...
var replacer = function(options) {
	...
	return function(key, value2) {
		try {
			if (key === "") return keys = [], objects = new Map([[value2, "[]"]]), map = /* @__PURE__ */ new Map(), stack = [], value2;
...
var SourceContext = (0, import_react.createContext)({ sources: {} }), UNKNOWN_ARGS_HASH = "--unknown--", SourceContainer = ({ children, channel }) => {
	...
	return (0, import_react.useEffect)(() => {
		let handleSnippetRendered = (idOrEvent, inputSource = null, inputFormat = !1) => {
			let { id, args = void 0, source, format: format3 } = typeof idOrEvent == "string" ? {
				id: idOrEvent,
				source: inputSource,
				format: inputFormat
...
var getStorySource = (storyId, args, sourceContext) => {
	...
	if ("of" in props && of === void 0) throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
	let sourceParameters = story?.parameters?.docs?.source || {}, format3 = props.format, language = props.language ?? sourceParameters.language ?? "jsx", dark = props.dark ?? sourceParameters.dark ?? !1;
...
var { document: document2 } = globalThis, assertIsFn = (val) => {
	...
	if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g))) return import_react.createElement(ii, null, children);
...
var A2 = yO.a, AnchorInPage = ({ hash, children }) => {
	...
	return import_react.createElement(Component4, { ...J(withoutAs, as) });
...
var { document: document3, window: globalWindow3 } = globalThis, DocsContainer = ({ context, theme, children }) => {
	...
	}), import_react.createElement(DocsContext.Provider, { value: context }, import_react.createElement(SourceContainer, { channel: context.channel }, import_react.createElement(Tt, { theme: pf(theme) }, import_react.createElement(DocsPageWrapper, { toc: toc ? import_react.createElement(TableOfContents, {
...
var slugs = new BananaSlug(), Heading2 = ({ children, disableAnchor,...props }) => {
	if (disableAnchor || typeof children != "string") return import_react.createElement(ui, null, children);
...
var Subheading = ({ children, disableAnchor }) => {
	if (disableAnchor || typeof children != "string") return import_react.createElement(fi, null, children);
	let tagID = slugs.slug(children.toLowerCase());
	return import_react.createElement(HeaderMdx, {
		as: "h3",
		id: tagID
...
var StyledHeading = xr(Heading2)(({ theme }) => ({
	fontSize: `${theme.typography.size.s2 - 1}px`,
	fontWeight: theme.typography.weight.bold,
	lineHeight: "16px",
	letterSpacing: "0.35em",
...
var preview, ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react.createElement(Tt, { theme: pf(Me.light) }, children)));
var Meta = ({ of }) => {
	let context = (0, import_react.useContext)(DocsContext);
...
var Wrapper10 = ({ children }) => import_react.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var PRIMARY_STORY = "^";

//#endregion
export { AddContext, Anchor, AnchorMdx, ArgTypes, ArgsTable, BooleanControl, Canvas, CodeOrSourceMdx, ColorControl, ColorItem, ColorPalette, Controls3, DateControl, DescriptionContainer, DescriptionType, Docs, DocsContainer, DocsContext, DocsPage, DocsStory, ExternalDocs, ExternalDocsContainer, FilesControl, HeaderMdx, HeadersMdx, Heading2, IconGallery, IconItem, Markdown, Meta, NumberControl, ObjectControl, OptionsControl, PRIMARY_STORY, Primary, RangeControl, Source2, SourceContainer, SourceContext, Stories, Story2, Subheading, Subtitle2, TableOfContents, TextControl, Title3, Typeset, UNKNOWN_ARGS_HASH, Unstyled, Wrapper10, anchorBlockIdFromId, argsHash, assertIsFn, extractTitle, format2, formatDate, formatTime, getStoryId2, getStoryProps, parse2, parseDate, parseTime, slugs, useOf, useSourceProps };
//# sourceMappingURL=blocks-ChXDUNP9.js.map