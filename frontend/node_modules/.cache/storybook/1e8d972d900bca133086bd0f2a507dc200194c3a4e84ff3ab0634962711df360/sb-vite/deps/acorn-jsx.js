...
var require_xhtml = /* @__PURE__ */ __commonJS({ "node_modules/acorn-jsx/xhtml.js": ((exports, module) => {
	module.exports = {
		quot: "\"",
		amp: "&",
		apos: "'",
...
var require_acorn = /* @__PURE__ */ __commonJS({ "node_modules/acorn/dist/acorn.js": ((exports, module) => {
	(function(global, factory) {
		...
		pp$8.parseStatement = function(context, topLevel, exports$2) {
			...
			switch (starttype) {
				...
				case types$1._import:
					...
					return starttype === types$1._import ? this.parseImport(node) : this.parseExport(node, exports$2);
				default:
		...
		pp$8.parseExportAllDeclaration = function(node, exports$2) {
			if (this.options.ecmaVersion >= 11) if (this.eatContextual("as")) {
				node.exported = this.parseModuleExportName();
				this.checkExport(exports$2, node.exported, this.lastTokStart);
		...
		pp$8.parseExport = function(node, exports$2) {
			this.next();
			if (this.eat(types$1.star)) return this.parseExportAllDeclaration(node, exports$2);
			if (this.eat(types$1._default)) {
				this.checkExport(exports$2, "default", this.lastTokStart);
				node.declaration = this.parseExportDefaultDeclaration();
				return this.finishNode(node, "ExportDefaultDeclaration");
			}
			if (this.shouldParseExportStatement()) {
				node.declaration = this.parseExportDeclaration(node);
				if (node.declaration.type === "VariableDeclaration") this.checkVariableExport(exports$2, node.declaration.declarations);
				else this.checkExport(exports$2, node.declaration.id, node.declaration.id.start);
				node.specifiers = [];
				node.source = null;
				if (this.options.ecmaVersion >= 16) node.attributes = [];
			} else {
				node.declaration = null;
				node.specifiers = this.parseExportSpecifiers(exports$2);
		...
		pp$8.checkExport = function(exports$2, name, pos) {
			if (!exports$2) return;
			if (typeof name !== "string") name = name.type === "Identifier" ? name.name : name.value;
			if (hasOwn(exports$2, name)) this.raiseRecoverable(pos, "Duplicate export '" + name + "'");
			exports$2[name] = true;
		};
		pp$8.checkPatternExport = function(exports$2, pat) {
			var type = pat.type;
			if (type === "Identifier") this.checkExport(exports$2, pat, pat.start);
			else if (type === "ObjectPattern") for (var i$1 = 0, list$1 = pat.properties; i$1 < list$1.length; i$1 += 1) {
				var prop = list$1[i$1];
				this.checkPatternExport(exports$2, prop);
			}
			else if (type === "ArrayPattern") for (var i$1$1 = 0, list$1$1 = pat.elements; i$1$1 < list$1$1.length; i$1$1 += 1) {
				var elt = list$1$1[i$1$1];
				if (elt) this.checkPatternExport(exports$2, elt);
			}
			else if (type === "Property") this.checkPatternExport(exports$2, pat.value);
			else if (type === "AssignmentPattern") this.checkPatternExport(exports$2, pat.left);
			else if (type === "RestElement") this.checkPatternExport(exports$2, pat.argument);
		};
		pp$8.checkVariableExport = function(exports$2, decls) {
			if (!exports$2) return;
			for (var i$1 = 0, list$1 = decls; i$1 < list$1.length; i$1 += 1) {
				var decl = list$1[i$1];
				this.checkPatternExport(exports$2, decl.id);
			}
		};
		pp$8.shouldParseExportStatement = function() {
			return this.type.keyword === "var" || this.type.keyword === "const" || this.type.keyword === "class" || this.type.keyword === "function" || this.isLet() || this.isAsyncFunction();
		};
		pp$8.parseExportSpecifier = function(exports$2) {
			var node = this.startNode();
			node.local = this.parseModuleExportName();
			node.exported = this.eatContextual("as") ? this.parseModuleExportName() : node.local;
			this.checkExport(exports$2, node.exported, node.exported.start);
			return this.finishNode(node, "ExportSpecifier");
		};
		pp$8.parseExportSpecifiers = function(exports$2) {
			...
			while (!this.eat(types$1.braceR)) {
				...
				nodes.push(this.parseExportSpecifier(exports$2));
			}
			return nodes;
		};
...
var require_acorn_jsx = /* @__PURE__ */ __commonJS({ "node_modules/acorn-jsx/index.js": ((exports, module) => {
