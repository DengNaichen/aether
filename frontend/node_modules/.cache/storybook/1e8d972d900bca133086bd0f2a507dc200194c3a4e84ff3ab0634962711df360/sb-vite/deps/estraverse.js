...
var require_estraverse = /* @__PURE__ */ __commonJS({ "node_modules/estraverse/estraverse.js": ((exports) => {
	(function clone(exports$1) {
		...
		Controller.prototype.path = function path() {
			...
			function addToPath(result$1, path$1) {
				if (Array.isArray(path$1)) for (j = 0, jz = path$1.length; j < jz; ++j) result$1.push(path$1[j]);
				else result$1.push(path$1);
			}
		...
		Controller.prototype.replace = function replace$1(root, visitor) {
			...
			function removeElem(element$1) {
				var i, key$1, nextElem, parent;
				if (element$1.ref.remove()) {
					key$1 = element$1.ref.key;
					parent = element$1.ref.parent;
					i = worklist.length;
					while (i--) {
						nextElem = worklist[i];
