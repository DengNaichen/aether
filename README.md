...
- Users: `GET /users/me`
- My graphs: `GET/POST /me/graphs`, `GET /me/graphs/{id}`, `POST /me/graphs/{id}/enrollments`, `POST /me/graphs/{id}/nodes|prerequisites|questions`, `POST /me/graphs/{id}/import-structure`, `POST /me/graphs/{id}/upload-file`, `GET /me/graphs/{id}/next-question|visualization|content`
