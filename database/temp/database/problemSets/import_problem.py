        ...
        for file_name in file_list:
            try:
                with open(file_name, 'r', encoding='utf-8') as f:
                    ...
                    logging.info(f"  - Successfully loaded {file_name} ({len(problems)} problems found)")
    ...
    def create_graph_in_neo4j(self, problems):
        ...
        try:
            with self.driver.session(database=self.database) as session:
                logging.info("Importing problems and their relationships to concepts...")
                ...
                logging.info(f"Successfully created {nodes_created} nodes and {relationships_created} relationships.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if merged_data:
            problems_with_ids = importer.create_problem_id_and_data(merged_data, Config.ID_PREFIX)
